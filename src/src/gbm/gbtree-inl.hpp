...
//      utils::Printf("ngroup = %i, nrow = %i\n", ngroup, gpair.size()/ngroup);
...
//          utils::Printf("gid = %i, i = %i, grad = %lf, hess = %lf\n", gid, i, tmp[i].grad, tmp[i].hess);
        }
